...
public class AI_B0 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        DeliverCallback deliverCallback = (s, delivery) -> {
            ...
            System.out.println("[AI_B0] Received with RabbitMQ:\n" + inMsg);

            String outMsg = inMsg + "B";
            channel.basicPublish(EXCHANGE_B, "", null, outMsg.getBytes(StandardCharsets.UTF_8));

            System.out.println("[AI_B0] Sent with RabbitMQ:\n" + outMsg);
        };

        CancelCallback cancelCallback = s -> System.out.println("[AI_B0] Callback Cancelled");
